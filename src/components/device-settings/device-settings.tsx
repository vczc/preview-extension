    ...
    return (
      <div className={`device-settings ` + (this.props.isVisible ? `active` : ``)}>
        ...
        <span className="metadata">
          <input className="viewport-size-input" type="number" min="0" value={viewportWidth} onChange={this.handleWidthChange} />
          <span className="spacer">𝗑</span>
          <input className="viewport-size-input" type="number" min="0" value={viewportHeight} onChange={this.handleHeightChange} />
        </span>
