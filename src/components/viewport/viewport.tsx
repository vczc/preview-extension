...
class Viewport extends React.Component<any, any> {
  ...
  public render() {
    ...
    return (
      <div className={`viewport ` + (this.props.isDeviceEmulationEnabled ? `viewport-resizable` : ``)} ref={this.viewportRef}>
  ...
  private calculateViewportZoom() {
    ...
    if (this.viewportMetadata.isFixedSize) {
      ...
      if (this.props.isDeviceEmulationEnabled) {
        ...
        screenViewportDimensions.width = screenViewportDimensions.width - this.viewportPadding.left - this.viewportPadding.right;
        screenViewportDimensions.height = screenViewportDimensions.height - this.viewportPadding.bottom - this.viewportPadding.top;
      }
  ...
  private calculateViewportSize() {
    ...
    if (this.viewportRef.current) {
      ...
      if (viewportWidth === this.roundNumber(this.viewportMetadata.width) && viewportHeight === this.roundNumber(this.viewportMetadata.height)) {
        return;
      }
