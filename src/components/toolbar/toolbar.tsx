  ...
  public render() {
    ...
    return (
      <div className="toolbar">
        <div className="inner">
          <button className={`inspect ` + (this.props.isInspectEnabled ? `active` : ``)} style={iconInspectStyle} onClick={this.handleInspect}>
            Inspect
          </button>
          <button
          ...
          <button className="backward" style={iconBackwardStyle} onClick={this.handleBack} disabled={this.props.canGoBack}>
            Backward
          </button>
          <button className="forward" style={iconForwardStyle} onClick={this.handleForward} disabled={this.props.canGoForward}>
            Forward
          </button>
          <button className="refresh" style={iconRefreshStyle} onClick={this.handleRefresh}>
            Refresh
          </button>
          <UrlInput url={this.props.url} onUrlChanged={this.handleUrlChange} onActionInvoked={this.props.onActionInvoked} />
        </div>
        <DeviceSettings
